...
public class SignUpActivity extends AppCompatActivity {
    ...
    private void register() {
        ...
        if (!ValidationUtils.isNotBlank(name) || !ValidationUtils.isValidEmail(email) || !ValidationUtils.isStrongEnoughPassword(password)) {
            setStatus("Vui lòng nhập họ tên, email hợp lệ và mật khẩu từ 6 ký tự.");
            return;
        }

        setStatus("Đang tạo tài khoản khách hàng...");
            ...
            public void onSuccess(User user) {
                ...
                authService.updateProfile(user, new SupabaseCallback<User>() {
                    ...
                    public void onSuccess(User updatedUser) {
                        ...
                        startActivity(new Intent(SignUpActivity.this, AccountHubActivity.class));
                        finish();
                    }
