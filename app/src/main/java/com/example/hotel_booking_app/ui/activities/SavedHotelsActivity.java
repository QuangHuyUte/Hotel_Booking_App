...
public class SavedHotelsActivity extends AppCompatActivity {
    ...
    private void loadWishlist() {
        statusTextView.setText("Đang tải danh sách đã lưu...");
    ...
    private void loadWishlistCabins(List<Wishlist> wishlists) {
        if (wishlists.isEmpty()) {
            ...
            statusTextView.setText("Bạn chưa lưu chỗ nghỉ nào.");
            return;
        }
        ...
        cabinService.getCabins(new SupabaseCallback<List<Cabin>>() {
            ...
            public void onSuccess(List<Cabin> cabins) {
                ...
                statusTextView.setText("Bạn có " + favoriteCabins.size() + " chỗ nghỉ đã lưu.");
            }
