...
public class NotificationsActivity extends AppCompatActivity {
    ...
    private void loadNotifications() {
        statusTextView.setText("Loading notifications...");
        notificationService.getNotifications(sessionManager.getUserId(), new SupabaseCallback<List<AppNotification>>() {
            ...
            public void onSuccess(List<AppNotification> notifications) {
                ...
                statusTextView.setText("You have " + notifications.size() + " notification(s).");
            }
    ...
    private void renderNotifications(List<AppNotification> notifications) {
        ...
        if (notifications.isEmpty()) {
            TextView empty = makeText("No notifications yet.");
        ...
        for (AppNotification notification : notifications) {
            ...
            TextView title = makeText((notification.isRead() ? "" : "New - ") + notification.getTitle());
            ...
            readButton.setText(notification.isRead() ? "Read" : "Mark as read");
