...
public class AiChatActivity extends AppCompatActivity {
    ...
    private void submitMessage(String message) {
        ...
        handler.postDelayed(() -> animateProgress(progress, "Đang đối chiếu booking, ngày khóa và số phòng còn lại..."), 720);
        handler.postDelayed(() -> animateProgress(progress, "Đang tìm được nhóm phòng phù hợp (1/3)..."), 1060);
        handler.postDelayed(() -> animateProgress(progress, "Đang so khớp tiện nghi, giường và giá (2/3)..."), 1400);
        handler.postDelayed(() -> animateProgress(progress, "Đang xếp hạng lựa chọn tốt nhất (3/3)..."), 1740);
