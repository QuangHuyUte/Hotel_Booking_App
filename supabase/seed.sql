...
alter table public.blocked_dates drop constraint if exists blocked_dates_valid_room_unit;
alter table public.blocked_dates add constraint blocked_dates_valid_room_unit check ("roomUnitNumber" is null or "roomUnitNumber" > 0);
...
insert into public.users (
  ...
  ('10000000-0000-4000-8000-000000000001', 'Huy Gia Lai', 'huy.manager@sereinstay.test', '123456', '+84900000001', 'MGR000001', date '2005-08-20', 'male', 'Ho Chi Minh City, Vietnam', 'Vietnamese', 'manager', timestamp '2026-07-20 08:00:00', timestamp '2026-07-20 08:00:00'),
  ('10000000-0000-4000-8000-000000000002', 'Cuong Manager', 'cuong.manager@sereinstay.test', '123456', '+84900000002', 'MGR000002', date '2005-07-20', 'male', 'Ho Chi Minh City, Vietnam', 'Vietnamese', 'manager', timestamp '2026-07-20 08:00:00', timestamp '2026-07-20 08:00:00'),
  ('10000000-0000-4000-8000-000000000003', 'Tran Tuan Kha', 'kha.manager@sereinstay.test', '123456', '+84900000003', 'MGR000003', date '2005-02-03', 'male', 'Vung Tau, Vietnam', 'Vietnamese', 'manager', timestamp '2026-07-20 08:00:00', timestamp '2026-07-20 08:00:00'),
  ('10000000-0000-4000-8000-000000000101', 'Alice Nguyen', 'alice.nguyen@sereinstay.test', '123456', '+84900000101', 'CUS000101', date '1995-03-20', 'female', 'Thu Duc, Ho Chi Minh City', 'Vietnamese', 'customer', timestamp '2026-07-20 08:00:00', timestamp '2026-07-20 08:00:00'),
  ('10000000-0000-4000-8000-000000000102', 'Bao Tran', 'bao.tran@sereinstay.test', '123456', '+84900000102', 'CUS000102', date '1992-08-12', 'male', 'Hai Chau, Da Nang', 'Vietnamese', 'customer', timestamp '2026-07-20 08:00:00', timestamp '2026-07-20 08:00:00'),
  ('10000000-0000-4000-8000-000000000103', 'Chi Pham', 'chi.pham@sereinstay.test', '123456', '+84900000103', 'CUS000103', date '1988-11-05', 'female', 'Hoan Kiem, Hanoi', 'Vietnamese', 'customer', timestamp '2026-07-20 08:00:00', timestamp '2026-07-20 08:00:00'),
  ('10000000-0000-4000-8000-000000000104', 'David Le', 'david.le@sereinstay.test', '123456', '+84900000104', 'CUS000104', date '1998-06-22', 'male', 'Nha Trang, Khanh Hoa', 'Vietnamese', 'customer', timestamp '2026-07-20 08:00:00', timestamp '2026-07-20 08:00:00'),
  ('10000000-0000-4000-8000-000000000105', 'Eve Hoang', 'eve.hoang@sereinstay.test', '123456', '+84900000105', 'CUS000105', date '1996-12-09', 'female', 'Hue City, Vietnam', 'Vietnamese', 'customer', timestamp '2026-07-20 08:00:00', timestamp '2026-07-20 08:00:00');
...
insert into public.room_types (
  ...
  ('30000000-0000-4000-8000-000000000001', '20000000-0000-4000-8000-000000000001', 'Saigon Standard Queen', 'Standard', '20-25 m2 room for short city stays.', 2, 2, 10, 84, '1 Queen bed', 'Queen', 1, 2, '1 Queen bed', '[{"type":"Queen","quantity":1,"adultCapacity":2}]'::jsonb, 1.6, 2.0, '24 m2', 24, false, 'WiFi, Air conditioning, Private bathroom', 'https://images.unsplash.com/photo-1505693416388-ac5ce068fe85?auto=format&fit=crop&w=1200&q=80', true, timestamp '2026-07-20 08:00:00', timestamp '2026-07-20 08:00:00'),
  ...
  ('30000000-0000-4000-8000-000000000011', '20000000-0000-4000-8000-000000000004', 'Da Nang Superior Ocean', 'Superior', '30 m2 room near My Khe Beach.', 2, 2, 8, 102, '1 Queen bed', 'Queen', 1, 2, '1 Queen bed', '[{"type":"Queen","quantity":1,"adultCapacity":2}]'::jsonb, 1.6, 2.0, '30 m2', 30, false, 'WiFi, Breakfast, Pool, Sea view', 'https://images.unsplash.com/photo-1560448204-e02f11c3d0e2?auto=format&fit=crop&w=1200&q=80', true, timestamp '2026-07-20 08:00:00', timestamp '2026-07-20 08:00:00'),
  ('30000000-0000-4000-8000-000000000012', '20000000-0000-4000-8000-000000000004', 'Da Nang Deluxe King', 'Deluxe', '43 m2 deluxe room with king bed.', 3, 3, 6, 138, '1 King bed and 1 sofa bed', 'King', 2, 3, '1 King bed and 1 sofa bed', '[{"type":"King","quantity":1,"adultCapacity":2},{"type":"Sofa Single","quantity":1,"adultCapacity":1}]'::jsonb, 1.8, 2.0, '43 m2', 43, false, 'WiFi, Breakfast, Pool, Sea view, Balcony', 'https://images.unsplash.com/photo-1570129477492-45c003edd2be?auto=format&fit=crop&w=1200&q=80', true, timestamp '2026-07-20 08:00:00', timestamp '2026-07-20 08:00:00'),
  ('30000000-0000-4000-8000-000000000013', '20000000-0000-4000-8000-000000000004', 'Da Nang Ocean Suite', 'Suite', '70 m2 ocean suite with living room.', 4, 4, 3, 210, '1 King bed and 1 sofa double', 'King', 2, 4, '1 King bed and 1 sofa double', '[{"type":"King","quantity":1,"adultCapacity":2},{"type":"Sofa Double","quantity":1,"adultCapacity":2}]'::jsonb, 1.8, 2.0, '70 m2', 70, true, 'WiFi, Breakfast, Pool, Sea view, Balcony', 'https://images.unsplash.com/photo-1582719478250-c89cae4dc85b?auto=format&fit=crop&w=1200&q=80', true, timestamp '2026-07-20 08:00:00', timestamp '2026-07-20 08:00:00'),
...
cross join lateral (
  ...
  from (
    values
      (1, 'Standard', '20-24 m2 room for quick stays', 2, 2, 10, 0.88, '1 Double bed', 'Double', 1, 2, '1 Double bed', '[{"type":"Double","quantity":1,"adultCapacity":2}]', 1.5, 24, false, 'WiFi, Air conditioning, Private bathroom'),
      (2, 'Superior', '26-30 m2 queen room with extra comfort', 2, 2, 8, 1.02, '1 Queen bed', 'Queen', 1, 2, '1 Queen bed', '[{"type":"Queen","quantity":1,"adultCapacity":2}]', 1.6, 28, false, 'WiFi, Breakfast, Air conditioning, Private bathroom'),
      (3, 'Deluxe', '32-40 m2 room for couples or small groups', 3, 3, 6, 1.18, '1 King bed and 1 sofa bed', 'King', 2, 3, '1 King bed and 1 sofa bed', '[{"type":"King","quantity":1,"adultCapacity":2},{"type":"Sofa Single","quantity":1,"adultCapacity":1}]', 1.8, 36, false, 'WiFi, Breakfast, Air conditioning, Private bathroom, Balcony'),
      (4, 'Suite', '44-55 m2 suite with separate living room', 4, 4, 4, 1.42, '1 King bed and 1 sofa double', 'King', 2, 4, '1 King bed and 1 sofa double', '[{"type":"King","quantity":1,"adultCapacity":2},{"type":"Sofa Double","quantity":1,"adultCapacity":2}]', 1.8, 50, true, 'WiFi, Breakfast, Air conditioning, Private bathroom, Balcony')
...
cross join lateral (
  values
    ('Standard', '20-24 m2 room for short stays', 2, 2, 10, 0.88, '1 Double bed', 'Double', 1, 2, '1 Double bed', '[{"type":"Double","quantity":1,"adultCapacity":2}]', 1.5, 24, false, 'WiFi, Air conditioning, Private bathroom'),
    ('Superior', '26-30 m2 queen room with extra comfort', 2, 2, 8, 1.02, '1 Queen bed', 'Queen', 1, 2, '1 Queen bed', '[{"type":"Queen","quantity":1,"adultCapacity":2}]', 1.6, 28, false, 'WiFi, Breakfast, Air conditioning, Private bathroom'),
    ('Deluxe', '32-40 m2 room with more comfort', 3, 3, 6, 1.18, '1 King bed and 1 sofa bed', 'King', 2, 3, '1 King bed and 1 sofa bed', '[{"type":"King","quantity":1,"adultCapacity":2},{"type":"Sofa Single","quantity":1,"adultCapacity":1}]', 1.8, 36, false, 'WiFi, Breakfast, Air conditioning, Private bathroom, Balcony')
...
insert into public.blocked_dates (
  ...
  ('88000000-0000-4000-8000-000000000003', '20000000-0000-4000-8000-000000000001', '30000000-0000-4000-8000-000000000001', '10000000-0000-4000-8000-000000000001', 9, date '2026-07-25', date '2026-07-26', 'Demo booking: Standard Queen nearly sold out for this night', timestamp '2026-07-20 08:00:00', timestamp '2026-07-20 08:00:00');
...
insert into public.bookings (
  ...
  ('80000000-0000-4000-8000-000000000002', '10000000-0000-4000-8000-000000000102', '20000000-0000-4000-8000-000000000002', '30000000-0000-4000-8000-000000000007', 1, date '2026-08-10', date '2026-08-13', 3, 4, 564.00, 0.00, 539.00, 'confirmed', false, false, 'Family beach break', '70000000-0000-4000-8000-000000000002', 25.00, timestamp '2026-07-20 08:00:00', timestamp '2026-07-20 08:00:00'),
...
insert into public.messages (
  ...
  ('85000000-0000-4000-8000-000000000006', '84000000-0000-4000-8000-000000000003', '10000000-0000-4000-8000-000000000002', 'Phù hợp ạ. Suite đó cho tối đa 4 khách và có khu sinh hoạt riêng.', false, timestamp '2026-07-20 08:20:00'),
